...
const Sidebar = () => {
  ...
  return (
    <div className="fixed md:sticky top-0 pt-20 md:pt-0 min-h-screen md:h-screen z-30 flex-shrink-0 shadow-sm w-64 overflow-y-auto bg-white dark:bg-gray-800 lg:block">
      <Link
        href="/dashboard"
      ...
      <div className="fixed bottom-0 px-6 py-6 w-64 mx-auto mt-3 block">
        <button className="btn w-full text-white bg-emerald-500 active:bg-emerald-600 hover:bg-emerald-600">
          <MdLogout />
